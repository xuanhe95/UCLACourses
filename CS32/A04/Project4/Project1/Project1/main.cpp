...
/*
const string USER_DATAFILE  = "/Users/xyx/desktop/2023Winter/CS32/Project/project4/project4_draft/userExample.txt";
const string MOVIE_DATAFILE = "/Users/xyx/desktop/2023Winter/CS32/Project/project4/project4_draft/movieExample.txt";
...
int main() {
    ...
    User* userPtr1 = dbs.get_users()[0];
    cout << userPtr1->get_full_name() << endl;
    cout << userPtr1->get_email() << endl;
    User* userPtr2 = dbs.get_users()[1];
    cout << userPtr2->get_full_name() << endl;
    cout << userPtr2->get_email() << endl;
    TreeMultimap <std::string, User*> userMap = dbs.get_userMap();
    TreeMultimap<std::string, User*>::Iterator itUser = dbs.get_userMap_it("AbFow2483@charter.net");
...
/*int main() {
    ...
    cout << movies1[1] << " " << movies1[2]  << endl;
    cout << movies1_1[1] << " " << movies1_1[2] <<endl;
}
 */
